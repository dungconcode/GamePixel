...
public class Player_BowAttack : MonoBehaviour, IAttackable
{
    ...
    public void Skill3Active()
    {
        if(skill3 != null)
        {
            skill3.GetComponent<Skill3_SeedBullet>().ActiveSkill(0f);
        }
    }
    public void ButtonActiveSkill3()
    {
        anim.SetBool("isActiveSkill3", true);
    }
